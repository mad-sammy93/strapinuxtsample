        ...
        <div class="display_div">
          <div class="screen_out">
            <div class="screen_out1">
              <div class="screen">
                <span v-if="message" class="notfound_text">{{ message }}</span>
                <span v-else class="notfound_text">Check Your Network :(</span>
              </div>
            </div>
          </div>
        </div>
...
.antenna_shadow {
  ...
  box-shadow: inset 0px 16px #383737, inset 0px 16px 1px 1px #a85103;
  -moz-box-shadow: inset 0px 16px #716a63, inset 0px 16px 1px 1px #a85103;
}
.antenna::after {
  content: '';
  position: absolute;
...
.tv {
  ...
  box-shadow: inset 0.2em 0.2em #c3c3c3;
}
.tv::after {
  content: '';
  position: absolute;
  ...
  height: 9em;
  border-radius: 15px;
  background: repeating-radial-gradient(#9e836c 0 0.0001%, #00000070 0 0.0002%) 50% 0/2500px 2500px, repeating-conic-gradient(#766a60 0 0.0001%, #00000070 0 0.0002%) 60% 60%/2500px 2500px;

...
<template>
    <div class="bg-white rounded-lg overflow-hidden shadow-lg">
      <NuxtImg v-if="dishInfo.imageUrl" :src="$getImageUrl(dishInfo.imageUrl)" :alt="dishInfo.imageAlt" class="w-full object-cover  top h-screen [width:100%]" :class="(size=='full'? 'object-bottom [height:600px]': 'object-center [height:300px]')" />
      <div class="p-4">
